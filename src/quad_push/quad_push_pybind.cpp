...
static std::vector<double> dquad_push_dk_wrapper(DQuadPushFunc func,
    double x, double y, double t,
    double px, double py, double pt, 
    double k, double slice_ds, double pt_ref
)
...
{
    return dquad_push_dk_wrapper(&dquad_push_dk_enzyme,
...
{
    return dquad_push_dk_wrapper(&dquad_push_dk_analytic,
            x, y, t, px, py, pt, k, slice_ds, pt_ref);
}
